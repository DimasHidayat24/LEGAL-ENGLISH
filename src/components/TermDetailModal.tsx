...
export const TermDetailModal: React.FC = () => {
  ...
  return (
    <div 
      className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 md:p-6 bg-[#050505]/80 backdrop-blur-xl transition-opacity duration-200"
      onClick={(e) => {
    ...
    >
      <div 
        className="glass-panel-deep backdrop-blur-2xl text-[#F2F2F2] w-full max-w-3xl max-h-[92vh] sm:max-h-[88vh] flex flex-col rounded-2xl sm:rounded-3xl overflow-hidden relative shadow-[0_25px_60px_rgba(0,0,0,0.7)] border border-white/12 dark:border-white/12 border-black/10 animate-in fade-in zoom-in-95 duration-200"
        role="dialog"
        aria-modal="true"
        aria-labelledby="term-detail-title"
      >
        {/* Pinned / Sticky Header Bar */}
        <header className="flex-shrink-0 border-b border-white/10 dark:border-white/10 border-black/10 bg-[#0E0E0E]/90 dark:bg-[#0E0E0E]/90 bg-white/95 backdrop-blur-xl z-20 px-5 sm:px-7 py-4 sm:py-5">
          <div className="flex items-start justify-between gap-3">
            <div className="space-y-2 min-w-0">
              <div className="flex flex-wrap items-center gap-1.5">
                <span className="text-[10px] font-sans font-semibold tracking-wider uppercase px-2.5 py-0.5 bg-[#1C1C1C] text-white border border-white/10 dark:border-white/10 border-black/10 rounded-full">
                  {term.category}
                </span>
                {term.termType && (
                  <span className="text-[10px] font-sans font-semibold px-2.5 py-0.5 bg-[#151515] dark:bg-[#151515] bg-[#F0F0F0] text-[#A8A8A8] border border-white/10 dark:border-white/10 border-black/10 rounded-full">
                    {term.termType}
                  </span>
                )}
                {term.jurisdiction && (
                  <span className="text-[10px] font-sans font-normal px-2.5 py-0.5 bg-[#101010] dark:bg-[#101010] bg-[#EEEEEE] text-[#A8A8A8] border border-white/10 dark:border-white/10 border-black/10 rounded-full flex items-center gap-1">
                ...
                <span className="text-[10px] px-2.5 py-0.5 bg-[#181818] dark:bg-[#181818] bg-[#F0F0F0] text-white border border-white/10 dark:border-white/10 border-black/10 font-sans font-semibold rounded-full">
                  {term.difficulty}
                </span>
              </div>

              <div className="flex flex-wrap items-center gap-2.5 sm:gap-3 pt-0.5">
                <h2 id="term-detail-title" className="text-xl sm:text-2xl md:text-3xl font-sans font-extrabold tracking-tight text-[#FFFFFF]">
                  {term.term}
                </h2>
                {term.pronunciation && (
                  <span className="text-xs sm:text-sm font-mono font-medium text-white bg-[#1C1C1C] dark:bg-[#1C1C1C] bg-[#F0F0F0] px-2.5 py-0.5 sm:py-1 rounded-full border border-white/10 dark:border-white/10 border-black/10">
                    {term.pronunciation}
                  </span>
                )}

                {/* Pronunciation Audio Button with Accent Selector */}
                <div className="flex items-center gap-1 bg-[#101010]/90 dark:bg-[#101010]/90 bg-[#F0F0F0] p-0.5 sm:p-1 rounded-full border border-white/10 dark:border-white/10 border-black/10">
                  ...
                  <button
                    ...
                    className="px-1.5 sm:px-2 py-0.5 text-[10px] font-sans font-bold text-white hover:text-[#DCDCDC] cursor-pointer rounded-full"
            ...
            <div className="flex items-center gap-1.5 shrink-0 pt-1">
              ...
              <button
                ...
                className="px-2.5 sm:px-3 py-1.5 border transition-all flex items-center gap-1 text-xs font-sans cursor-pointer rounded-full shadow-xs bg-[#151515] dark:bg-[#151515] bg-[#F0F0F0] text-[#A8A8A8] border-white/10 dark:border-white/10 border-black/10 hover:bg-[#1C1C1C] hover:text-[#FFFFFF]"
              >
              ...
              <button
                ...
                className={`px-2.5 sm:px-3.5 py-1.5 border transition-all flex items-center gap-1.5 text-xs font-sans cursor-pointer rounded-full shadow-xs ${
                  isSaved 
                    ? 'bg-[#242424] text-white border-white/20 font-bold' 
                    : 'bg-[#151515] dark:bg-[#151515] bg-[#F0F0F0] text-[#A8A8A8] border-white/10 dark:border-white/10 border-black/10 hover:bg-[#1C1C1C] hover:text-[#FFFFFF]'
                }`}
              >
              ...
              <button
                ...
                className="p-1.5 text-[#A8A8A8] hover:text-[#FFFFFF] hover:bg-[#1C1C1C] dark:hover:bg-[#1C1C1C] hover:bg-[#E2EDF9] transition-colors cursor-pointer rounded-full"
        ...
        >
          ...
          <div className="p-4 rounded-2xl lexa-surface-subtle space-y-2">
            <div className="text-[10px] font-sans uppercase tracking-wider text-[#A8A8A8] flex items-center gap-1.5 font-bold">
              <Scale className="w-3.5 h-3.5 text-white" />
              Padanan Bahasa Indonesia & Konstruksi Hukum
            </div>
            <p className="text-base sm:text-lg font-sans font-extrabold text-[#FFFFFF]">
              {term.indonesianMeaning}
            </p>
            <p className="text-xs sm:text-sm text-[#A8A8A8] leading-relaxed font-sans font-normal">
              {term.indonesianLegalConcept}
            </p>
            {term.civilLawEquivalent && (
              <div className="text-xs font-sans text-[#A8A8A8] pt-2 border-t border-white/[0.08]">
                <span className="text-[#707070]">Civil Law / KUHPerdata Counterpart:</span>{' '}
                <span className="text-white font-bold">{term.civilLawEquivalent}</span>
              </div>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            <div className="p-4 rounded-2xl lexa-surface-subtle space-y-1.5">
              <span className="text-[10px] font-sans uppercase tracking-wider text-[#A8A8A8] block font-bold">
                Plain English Explanation
              </span>
              <p className="text-xs sm:text-sm text-[#A8A8A8] font-sans font-normal leading-relaxed">
          ...
          <div className="p-4 rounded-2xl lexa-surface-subtle space-y-1.5">
            <span className="text-[10px] font-sans uppercase tracking-wider text-[#FFFFFF] block font-bold">
          ...
          {term.authenticClauseExcerpt && (
            <div className="border border-white/[0.08] bg-[#101010] p-4 rounded-2xl">
              <div className="flex items-center justify-between mb-2">
                <span className="text-[10px] font-sans uppercase tracking-wider text-white flex items-center gap-1.5 font-semibold">
                  <FileText className="w-3.5 h-3.5 text-white" />
                  Authentic Contract Clause Excerpt
                </span>
                {term.authenticClauseSource && (
                  <span className="text-[10px] font-sans text-[#707070] italic">
                    Source: {term.authenticClauseSource}
                  </span>
                )}
              </div>
              <blockquote className="font-serif italic text-xs sm:text-sm text-[#F2F2F2] pl-3 border-l-2 border-white/60 my-2 leading-[1.7] bg-[#080808] p-3 rounded-xl">
          ...
          {term.contextExamples && (
            <div className="border border-white/[0.08] bg-[#101010] p-4 rounded-2xl space-y-3">
                ...
                <button
                  ...
                  className={`px-3 py-1 text-xs font-sans rounded-full cursor-pointer flex items-center gap-1.5 transition-all ${
                    activeContextTab === 'contracts'
                      ? 'bg-[#1C1C1C] text-white font-semibold border border-white/20'
              ...
              <div className="text-xs sm:text-sm font-serif text-[#F2F2F2] bg-[#080808] p-3 rounded-xl leading-[1.7] border border-white/[0.08]">
                {activeContextTab === 'contracts' && (
          ...
          <div className="space-y-2">
            ...
            <div className="p-3.5 border border-white/[0.08] lexa-surface-subtle space-y-1.5 rounded-2xl">
              <p className="text-sm font-semibold text-white font-sans">
                {term.exampleSentenceEn}
              </p>
              <p className="text-xs text-[#A8A8A8] font-sans italic border-t border-white/[0.08] pt-1.5">
          ...
          {term.commonCollocations && term.commonCollocations.length > 0 && (
            <div>
              <span className="text-[10px] font-sans uppercase tracking-wider text-[#A8A8A8] block mb-2 font-semibold">
              ...
              <div className="flex flex-wrap gap-1.5">
                {term.commonCollocations.map((col, idx) => (
                  <span
                    key={idx}
                    className="text-xs font-sans px-3 py-1 bg-[#151515] text-[#A8A8A8] border border-white/[0.08] rounded-full font-medium"
                  >
                    {col}
                  </span>
                ))}
          ...
          {term.connectedDocIds && term.connectedDocIds.length > 0 && (
            <div className="p-4 rounded-2xl lexa-surface-subtle space-y-2">
              <div className="text-[10px] font-sans uppercase tracking-wider text-white flex items-center gap-1.5 font-semibold">
                <FileText className="w-3.5 h-3.5 text-white" />
              ...
              <div className="flex flex-wrap gap-2 pt-1">
                {term.connectedDocIds.map((docRef) => (
                  <button
                    ...
                    className="text-xs font-sans px-3 py-1.5 bg-[#1C1C1C] hover:bg-[#242424] border border-white/[0.08] hover:border-white/25 text-white font-medium rounded-full cursor-pointer flex items-center gap-1.5 transition-all shadow-xs"
                  >
                    <span>Read in: <span className="text-[#DCDCDC]">{docRef.title || docRef.docId.replace(/-/g, ' ')}</span></span>
          ...
          <div className="p-4 rounded-2xl lexa-surface-subtle space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-sans uppercase tracking-wider text-[#A8A8A8] font-semibold">
              ...
              {!isEditingNote && (
                <button
                  ...
                  className="text-xs font-sans text-white hover:text-[#DCDCDC] cursor-pointer font-medium underline"
                >
            ...
            {isEditingNote ? (
              <div className="space-y-2">
                <textarea
                  ...
                  className="w-full text-xs font-sans p-3 bg-[#080808] border border-white/15 text-[#F2F2F2] placeholder:text-[#707070] rounded-xl focus:outline-none focus:border-white resize-none h-20"
                />
                <div className="flex items-center justify-end gap-2">
                  <button
                    onClick={() => setIsEditingNote(false)}
                    className="px-3 py-1 text-xs text-[#A8A8A8] hover:text-white cursor-pointer"
                  >
                    Cancel
                  </button>
                  <button
              ...
              savedRecord?.notes && (
                <p className="text-xs font-sans text-[#A8A8A8] italic bg-[#080808] p-3 rounded-xl border border-white/[0.08]">
          ...
          <div className="pt-6 pb-4 border-t border-white/[0.08] flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] font-sans text-[#707070]">
            <div className="flex items-center gap-2">
              <button
                ...
                className={`flex items-center gap-1 px-3 py-1.5 rounded-full border transition-all ${
                  prevTerm
                    ? 'bg-[#151515] text-[#A8A8A8] border-white/[0.08] hover:text-white hover:bg-[#1C1C1C] cursor-pointer'
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                type="button"
                onClick={() => setActiveLookupTermId(null)}
                className="text-white hover:text-[#DCDCDC] font-semibold cursor-pointer px-2 py-1 underline"
              >
                Close Window (Esc)
              </button>
            </div>
